...
{:else if data}
  ...
  <div class="summary-grid fact-strip" aria-label="Account selection summary">
    <div>
...
<style>
  ...
  .account-table tr:not(.current-row) > td:first-child {
  ...
  @media (max-width: 1100px) {
    ...
    .account-table tr > td:not(:first-child) {
      padding-left: 12px;
    }
