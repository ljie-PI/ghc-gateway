...
export const SYNTHETIC_MODELS = {
  data: [
    // Anthropic and Responses SDK cases convert tool and image requests to CHAT_MODEL; converted routes require declared support.
    { id: CHAT_MODEL, name: "SDK Chat", vendor: "github", model_picker_enabled: true, capabilities: { supports: { tool_calls: true, parallel_tool_calls: true, vision: true } }, model_info: { supported_endpoints: ["/v1/chat/completions"], supported_parameters: ["temperature", "top_p", "response_format", "reasoning_effort"], supported_reasoning_efforts: ["none", "minimal", "low", "medium", "high", "xhigh"], max_input_tokens: 128_000, max_output_tokens: 16_384, chat_output_token_field: "max_tokens" } },
